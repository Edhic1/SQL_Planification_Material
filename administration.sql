...
GRANT SELECT ON MATERIEL WHERE IDMATERIEL IN (SELECT IDMATERIEL FROM AFFECTATIONMATERIEL WHERE PN = SYS_CONTEXT('USERENV', 'SESSION_USER')) TO ROLEEMP;
GRANT SELECT ON CONTIENT WHERE IDMATERIEL IN (SELECT IDMATERIEL FROM AFFECTATIONMATERIEL WHERE PN = SYS_CONTEXT('USERENV', 'SESSION_USER')) TO ROLEEMP;
