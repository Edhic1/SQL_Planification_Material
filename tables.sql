...
CREATE TABLE PROJET (
    ...
    ETATPROJ VARCHAR2 DEFAULT 'en cours de execution' NOT NULL,
...
CREATE TABLE MATERIEL (
    ...
    CONSTRAINT FK_MATPROJ FOREIGN KEY(IDPROJ) REFERENCES PROJECT(IDPROJ)
);
...
CREATE TABLE CONTIENT (
    ...
    CONSTRAINT FK_PROJET FOREIGN KEY (IDPROJ) REFERENCE PROJECT(IDPROJ),
    CONSTRAINT FK_MATERIEL FOREIGN KEY (ID_MAT) REFERENCE PROJECT(ID_MAT)
);
